...
func fetchZoneColocationAnalytics(zones []cloudflare.Zone, wg *sync.WaitGroup) {
	fmt.Println("fetchZoneColocationAnalytics: Start")
	wg.Add(1)
	defer wg.Done()
	...
	fmt.Println("fetchZoneColocationAnalytics: Done")
}

func fetchZoneCalendarMonthTotals(zones []cloudflare.Zone, wg *sync.WaitGroup) {
	fmt.Println("fetchZoneColocationCalendarMonth: Start")
	wg.Add(1)
	defer wg.Done()
	...
	fmt.Println("fetchZoneColocationCalendarMonth: Done")
}
